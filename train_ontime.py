...
def train(Agent=MonteCarloAgent, episode_count=10, report_interval=1, country="中国", save=False):
...
if __name__ == "__main__":
    Q = train(Agent=MonteCarloAgent, episode_count=2000000, report_interval=1000, country="中国", save=True)
